...
printf("Error Type: Contextual \n\n");
     ...
     printf("The format specifier in c for data type int is percsign d, So when we need to print y which is defined as an int data type needs to be printed it has to percsign d and can’t be percsign c which is used for char data type and can lead to Contextual error and your program doesn’t give desired output.  \n\n");
// Problem 4: (2 points)
// Float variable f has been initialized to 3.14, why does the program seem to think otherwise? Correct the error(s) (2 points).
float f = 3.14;
if (f == 10) //since the function instead of comparing (==) f it was initializing (=) the value of f
...
printf("Error Type: Semantic \n\n");
// Problem 6: (4 points)
// This bit of code is meant to print "Hello World!". Correct the error(s) (2points).
printf("Hello World!\n");
// Define what type of error this is, your answer should replace the space next to "Error Type: " below (2 points).
// Your answer should be either Syntactic, Semantic, or Contextual.
printf("Error Type: Contextual \n\n");
