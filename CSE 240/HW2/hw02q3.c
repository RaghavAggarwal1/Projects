...
void part1(int x) {
	...
	printf("Explanation: while calling macros with operators like '++'; operators might get evaluated multiple times. Hence if we increment value before we will get a value of +2 hence 11 and if we increment after the program will increment once hence 10.\n\n\n"); // (2.5 points)
}
