      ...
      public FireworkControlPane(int width, int height, Color initialColor)
       {
           ...
           //create a slider for the number of beams/arcs for the firework with major tick spacing 4,
  ...
  private class ButtonHandler implements EventHandler<ActionEvent>
   {
     ...
     private class ColorHandler implements EventHandler<ActionEvent>
     {
         public void handle(ActionEvent event)
         {
             //getting the color and setting it accordingly
   ...
   private class SpeedHandler implements ChangeListener<Number>
    {
                             ...
                             Number oldValue, Number newValue)
         {
             ...
             /***to be completed***/
             //getting the values and setting the speed accordingly
             int speedy =  (int)speed.getValue();
             fwPane.setRate(speedy);
         }
     ...
     private class BeamHandler implements ChangeListener<Number>
      {
                            ...
                            Number oldValue, Number newValue)
           {
             ...
             /***to be completed***/
             //getting the values and setting the beams accordingly
             int beams =  (int)beam.getValue();
             fwPane.setBeamNumber(beams);
           }
     } //end of BeamListener
 }
